...
import { X, ArrowRight, Box, Layers, Package, Component } from 'lucide-react';
        ...
        <div className="p-6 space-y-8 overflow-y-auto">
          ...
          <div className="flex flex-col items-center justify-center py-6 bg-slate-50 rounded-xl border border-dashed border-slate-300">
            <div className="flex items-end gap-1 relative">
                {/* Master */}
                <div className="border-2 border-emerald-400 bg-emerald-50 rounded-lg p-6 relative">
                    <span className="absolute top-0 right-2 text-[10px] font-bold text-emerald-600 uppercase tracking-wider bg-emerald-100 px-1 rounded">{t.diagramMaster}</span>
                    
                    <div className="flex items-end gap-2">
                        {/* Inner 1 */}
                        <div className="border-2 border-indigo-300 bg-indigo-50 rounded p-3 relative">
                            <span className="absolute top-0 left-1 text-[9px] font-bold text-indigo-500 uppercase">{t.diagramInner}</span>
                            <div className="flex gap-1 mt-2">
                                <div className="w-4 h-6 bg-slate-300 rounded-sm border border-slate-400"></div>
                                <div className="w-4 h-6 bg-slate-300 rounded-sm border border-slate-400"></div>
                                <div className="w-4 h-6 bg-slate-300 rounded-sm border border-slate-400"></div>
                            </div>
                        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
                 ...
                 <div className="flex gap-3">
                    <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center shrink-0 font-bold text-indigo-600">2</div>
                    <div>
            ...
            <div className="space-y-4">
                 <div className="flex gap-3">
                    <div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center shrink-0 font-bold text-purple-600">3</div>
                    <div>
                 ...
                 <div className="flex gap-3">
                    <div className="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center shrink-0 font-bold text-emerald-600">4</div>
                    <div>
                        <h3 className="font-bold text-slate-800">{t.step4Title}</h3>
                        <p className="text-sm text-slate-500 leading-relaxed">{t.step4Desc}</p>
                    </div>
                 </div>
            </div>
          </div>

          {/* N95 Example Card - Refined Layout */}
          <div className="border-t border-slate-200 pt-6">
            <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-bold text-slate-800 flex items-center gap-2">
                <span className="bg-amber-100 text-amber-800 text-xs font-bold px-2 py-1 rounded uppercase tracking-wider">Case Study</span>
                {t.n95ExampleTitle}
                </h3>
            </div>
            ...
            <div className="bg-slate-900 text-slate-200 rounded-xl overflow-hidden shadow-xl font-mono text-sm">
               ...
               <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-8">
                   ...
                   <div>
                       ...
                       <div className="space-y-4">
                           <div>
                               <div className="text-slate-400 text-xs mb-0.5">Inner Pack Dims</div>
                               <div className="text-slate-300">{t.n95InnerCalc}</div>
                               <div className="text-indigo-300 font-bold">{t.n95InnerResult}</div>
                           </div>
                           
                           <div>
                               <div className="text-slate-400 text-xs mb-0.5">Master Payload</div>
